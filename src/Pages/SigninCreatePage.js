...
const SigninCreatePage = ({ url }) => {
        ...
        axios.post(url + '/login', userData).then((res) => {
            ...
            if (res.data.status == "fail") {
                ...
                if (res.data.msg == "login") {
                    localStorage.setItem('user', res.data.userData[0].mobile)
    ...
    return (
        <div className="w-screen bg-sky-200 flex justify-center items-center h-screen">
                    ...
                    {signin ? <div className="w-[85%]">
                        ...
                        <div className="flex flex-col gap-5 pt-5">
                            <div className="flex justify-center gap-10">
                                <div className=" border  border-gray-50 rounded-lg p-3 text-rose-500 hover:bg-rose-500 hover:text-white cursor-pointer">
                                ...
                                <Link to="https://github.com/harshraj30"> <div className=" border  border-gray-50 rounded-lg p-3 text-rose-500 hover:bg-rose-500 hover:text-white cursor-pointer">
                        ...
                        <div className="w-full flex justify-center items-center">
                            <div className="w-[86%] py-3 gap-4 flex flex-col">
                                <input className=' bg-gray-100 border-none rounded-lg outline-none px-2 py-1' size={36} type="text" placeholder='Enter Your Name : ' name="" id="" />
                                <input className=' bg-gray-100 border-none rounded-lg outline-none px-2 py-1' size={36} type="email" placeholder='Enter Your Email : ' name="" id="" />
                                <input className=' bg-gray-100 border-none rounded-lg outline-none px-2 py-1' size={36} type="number" placeholder='Enter Your Mobile no. : ' name="" id="" />
                                <input className=' bg-gray-100 border-none rounded-lg outline-none px-2 py-1' size={36} type="Password" placeholder='Enter Your Password : ' name="" id="" />
                                <div className="flex justify-center">
                                    <button className='capitalize px-7 rounded-lg text-white font-semibold cursor-pointer hover:bg-rose-600 py-1 bg-rose-500 w-fit '>Sign Up</button>
                                </div>
                            </div>
                        </div>
                    </div> :
                        <div className="w-[85%]">
                            ...
                            <div className="w-full flex justify-center items-center">
                                <div className="w-[86%] py-3 gap-4 flex flex-col">
                                    <input value={userData.email} onChange={(e) => { setUserData({ ...userData, email: e.target.value }) }} className=' bg-gray-100 border-none rounded-lg outline-none px-2 py-1' size={36} type="email" placeholder='Enter Your Email : ' name="" id="" />
                                    ...
                                    <div className="flex justify-center">
                                        ...
                                        <button onClick={handleLogin} className='capitalize px-7 rounded-lg text-white font-semibold cursor-pointer hover:bg-rose-600 py-1 bg-rose-500 w-fit '>Login</button>
                                        {/* </Link> */}
                                    </div>
                                </div>
                            </div>
